 ...
 class Usuario{
            ...
            public function getId_province(){
                ...
                public function getUsersCollector(){
                    ...
                    $sql = "SELECT id,name as 'name_user' ,country,province,location,home_address,customer_service_hours, postal_code FROM users WHERE role = 'recolector' AND status_process = 'active' order by name asc";
