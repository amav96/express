<?php 
 ...
 class Rendicion{
            ...
            public function getRendicion(){
                ...
                e.telefono_cel4,telefono_cel5,telefono_cel6,e.emailcliente as 'email',g.identificacion,
                g.serie,g.terminal,g.serie_base,g.tarjeta,g.chip_alternativo,g.accesorios,g.id_orden_pass,g.accesorio_uno,g.accesorio_dos,
                g.accesorio_tres,g.accesorio_cuatro,g.motivo,g.estado,g.chip_alternativo,g.created_at,f.created_at as 'fecha_firma'
                from gestion g
