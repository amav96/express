            ...
            validateEquipoDB(infoEquipo,'1','#input-serie-aut',estadoInfo);
                ...
                if(getIdentificacionInputCuandoNoHayNada.substr(0,2) !== 'LA' && getIdentificacionInputCuandoNoHayNada.substr(0,2) !== 'PS' && getIdentificacionInputCuandoNoHayNada.substr(0,2) !== 'GC'){
                    ...
                    if (serieAutINPUT.val() === "") {
                        ...
                        if(getIdentificacionInputCuandoNoHayNada.substr(0,2) == 'MV'){
                            alertNegative("Debes ingresar el nro de MAC");return false;
                        }
                        alertNegative("Debes ingresar el nro de serie");return false;
                    }
...
`;
    ...
    if (nombreEmpresaCaja !== 'LA' && nombreEmpresaCaja !== 'PS' && nombreEmpresaCaja !== 'GC' && nombreEmpresaCaja !== 'MV') {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (reciboDataValidar[0].result !== 1) {
                $("#enviar").show();
                $("#loaderAutorizar").remove();
                alertNegative('El nro de SERIE/MAC ya existe en nuestra base de datos, ingrese otro o comuniquese con nuestras operadoras')  ;return false;
            } 
